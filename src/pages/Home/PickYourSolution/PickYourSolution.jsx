        ...
        <Container className=" my-5 py-5 ">
            ...
            <Row className=" d-flex justify-content-between align-items-center pt-5" >
                <Col className=" px-3 mb-5 mb-md-0 mb-xl-0 mb-xxl-0 " md={4}>
                    ...
                    <button data-aos='fade-up'  data-aos-duration='1000' style={{ border: "1px solid #C19732", background: "#272727", boxShadow: "0px 4px 40px 20px #C1973233" }} className="px-5 py-3 rounded-4 text-white fw-semibold">Get Quote</button>
                </Col>
