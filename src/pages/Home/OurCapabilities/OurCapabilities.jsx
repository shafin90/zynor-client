...
const OurCapabilities = () => {
    ...
    return (
        <Container className=" d-flex flex-column justify-content-between align-items-center my-5  py-5">
            ...
            <button data-aos='fade-up' data-aos-duration='1000' style={{ border: "1px solid #7D26CD", background: "#272727", boxShadow: "0px 4px 20px 10px #7D26CD33" }} className=" mx-auto px-5 py-3 rounded-4 text-white fw-bolder">View All</button>
