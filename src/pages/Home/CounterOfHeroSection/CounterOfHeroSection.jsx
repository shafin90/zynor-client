...
const CounterOfHeroSection = () => {
    ...
    return (
        <Container className=" my-5 py-5">
            <Row>
                <Col data-aos='fade-right'  data-aos-duration='1000' md={9} className=" rounded-4 mb-4 mb-md-0 mb-lg-0 mb-xl-0 mb-xxl-0">
                    <img src="/assets/Video.png" className=" w-100 h-100 " alt="" />
                </Col>

                <Col data-aos='zoom-out'  data-aos-duration='1000' md={3} className=" rounded-5 bg-dark p-5">
